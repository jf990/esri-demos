...
The purpose of this project is to easily test individual services to verify the service and authentication work according to expected operation.
...
| `ANALYSIS_SERVICE_URL` | When testing spatial analysis usage, your account/organization is assigned its own analysis services pod. |
